...
# session = FTP.FTPsession(host='intftp', username='svc-79800', password='84V!1GNXYIEp1@$G')
...
# db_session = DB_connection.DbSession(host='10.133.154.175',username='global_gsm', password='xc%$q2')
...
# import smtp
# smtp.send_email(server='mail.mtnirancell.ir', email='raheleh.b@mtnirancell.ir',password='******',
#                 to=['raheleh.b@mtnirancell.ir'], cc=['r.bhbhn@gmail.com'],subject='checking smtp', body='just testing',
